        ...
        <div className=' grid grid-cols-2 gap-6 '>
            <div class="column">
                <div class="carda">
                    <div class="content">
                        <div class="front">
                            <img class="profile" className=' h-64 ' src="https://images.immediate.co.uk/production/volatile/sites/30/2020/08/fruit_and_veg-fcb7b38.jpg?quality=90&resize=556,505" alt="" />
            ...
            <div class="column">
                <div class="carda">
                    <div class="content">
                        <div class="front">
                            <img class="profile" className='h-64 ' src="https://manmatters.com/blog/content/images/2022/03/Untitled-design---2022-03-07T175530.109_11zon.jpeg" alt="" />
            ...
            <div class="column">
                <div class="carda">
                    <div class="content">
                        <div class="front">
                            <img class="profile" className=' h-64' src="https://imagesvc.meredithcorp.io/v3/mm/image?q=60&c=sc&poi=face&w=2215&h=1108&url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F39%2F2012%2F06%2F20222319%2FBM_004730_sq.jpg" alt="" />
            ...
            <div class="column">
                <div class="carda">
                    <div class="content">
                        <div class="front">
                            <img class="profile" className=' h-64' src="https://media.istockphoto.com/id/1253099922/photo/assortment-of-fresh-fruits-and-vegetables-juices-in-rainbow-colors.jpg?b=1&s=170667a&w=0&k=20&c=GO3TiW3f8Oh0JQlkjLJcLs2mMvQjJcy10hMNhYuMNIg=" alt="" />
